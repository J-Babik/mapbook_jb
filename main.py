...
label_liczba_postow_wartosc = Label(ramka_szczegoly_obiektu, text="...")
...
label_nazwisko_szczegoly_obiektu.grid(row=1, column=3)
label_nazwisko_szczegoly_obiektu_wartosc.grid(row=1, column=4)
label_liczba_postow_szczegoly_obiektu.grid(row=1, column=5)
label_liczba_postow_wartosc.grid(row=1, column=6)
label_lokalizacja_szczegoly_obiektu.grid(row=1, column=7)
label_lokalizacja_szczegoly_obiektu_wartosc.grid(row=1, column=8)
