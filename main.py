...
def show_user_details():
    ...
    label_liczba_postow_wartosc.config(text=liczba_postow)
...
label_liczba_postow_wartosc = Label(ramka_szczegoly_obiektu, text="...", width=10)
...
label_liczba_postow_wartosc.grid(row=1, column=5, sticky=W)
